...
const FROM    = process.env.EMAIL_FROM    ?? "DocSwift <noreply@getdocswift.com>";
...
function btn(text, url, color = "#3B82F6") {
  return `<a href="${url}" style="display:inline-block;background:${color};color:#fff;text-decoration:none;padding:13px 28px;border-radius:10px;font-size:15px;font-weight:700;margin-top:8px;">${text}</a>`;
}
