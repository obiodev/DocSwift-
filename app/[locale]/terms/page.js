...
DocSwift est une marque appartenant à Motoko LLC, société enregistrée aux États-Unis.

Éditeur du service : Motoko LLC (opérant sous la marque DocSwift)
...
L'utilisateur est seul responsable des fichiers qu'il soumet. Il garantit disposer des droits nécessaires sur les documents traités. Il est interdit d'utiliser DocSwift pour traiter des contenus illicites, pornographiques, diffamatoires ou portant atteinte aux droits de tiers.`,
  },
  {
    ...
    content: `L'ensemble des éléments constitutifs de DocSwift (interface, logo, code source, textes, outils) sont protégés par le droit de la propriété intellectuelle et sont la propriété exclusive de Motoko LLC, titulaire de la marque DocSwift.
...
Société : Motoko LLC (marque DocSwift)
Email : support@getdocswift.com
Site web : getdocswift.com

Motoko LLC s'engage à répondre à toute demande dans un délai de 5 jours ouvrés.`,
  },
];
