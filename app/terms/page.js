      ...
      <div style={{ maxWidth:760,margin:"0 auto",padding:"60px 24px 100px" }}>
        ...
        <div style={{ marginBottom:48 }}>
          ...
          <p style={{ color:"#6B7A99",fontSize:15,lineHeight:1.6,marginBottom:8 }}>
            En utilisant DocSwift, vous acceptez les présentes conditions. Prenez le temps de les lire attentivement.
          </p>
          <div style={{ display:"flex",gap:16,flexWrap:"wrap" }}>
            <span style={{ color:"#4B5563",fontSize:13 }}>Dernière mise à jour : {LAST_UPDATE}</span>
            <span style={{ color:"#4B5563",fontSize:13 }}>·</span>
            <span style={{ color:"#4B5563",fontSize:13 }}>Applicable depuis : {LAST_UPDATE}</span>
          </div>
        </div>
        ...
        <div style={{ background:"rgba(16,185,129,.06)",border:"1px solid rgba(16,185,129,.15)",borderRadius:16,padding:"20px 24px",marginBottom:48 }}>
          <div style={{ fontWeight:700,fontSize:14,color:"#10B981",marginBottom:10 }}>✓ En résumé</div>
          <ul style={{ listStyle:"none",padding:0,margin:0,display:"flex",flexDirection:"column",gap:8 }}>
            {[
              "Vos fichiers sont traités et supprimés immédiatement, jamais stockés.",
              "Plan gratuit : 5 conversions/jour · Plan Pro : illimité à partir de 4,99€/mois.",
              "Vos CV et documents vous appartiennent à 100%.",
              "Annulation de l'abonnement à tout moment, sans frais.",
              "Données personnelles limitées à l'email (si connexion Google) et l'IP.",
            ].map((item,i) => (
